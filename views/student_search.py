...
class StudentSearch(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if((query is not None)):
            ...
            result_matches = Profile.objects.filter(
                Q(
                    student__person__full_name__icontains=query) | Q(
                    student__enrolment_number__icontains=query) | Q(
                    student__current_year__icontains=query) | Q(
                    student__branch__name__icontains=query) | Q(
                        student__person__contact_information__email_address__icontains=query))
            ...
            room_number_results = ResidentialInformation.objects.filter(
            ...
            bhawan_results = ResidentialInformation.objects.filter(
                Q(residence__code__icontains=query))
